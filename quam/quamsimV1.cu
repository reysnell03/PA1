...
int main(int argc, char *argv[]) {
    ...
    host_input = (float*)malloc(state_bytes);
    host_output = (float*)malloc(state_bytes);
    host_gate = (float*)malloc(gate_bytes);
    ...
    apply_quantum_gate<<<blocks_per_grid, threads_per_block>>>(device_input, device_output, device_gate, vector_length, qubit_index);
